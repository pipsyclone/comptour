...
export default function TAStoreComponent() {
    ...
    const {
        ...
        nameplace, setNamePlace, image, setImage, provinsi, kabupaten, kecamatan, longtitude, setLongtitude, latitude, setLatitude, desc, setDesc,
        ...
        <div className="container">
            ...
            <div className="card">
                <form onSubmit={TAonSubmit} className="row-column gap-3">
                    ...
                    <div className="row-column">
                        <label>Gambar ID Tempat Wisata : <span className="text-danger">*</span></label>
